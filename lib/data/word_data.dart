...
final Map<String, List<Map<String, dynamic>>> wordData = {
  ...
  'household': [
    ...
    },
    {
      ...
      'emoji': '⚽',
      'actions': [
        {'si': 'බෝල වලිතට දමන්න', 'ta': 'பந்து தூக්க', 'en': 'Throw ball'},
        {'si': 'බෝල පිඩිසි කරන්න', 'ta': 'பந்து உருட్ट', 'en': 'Roll ball'},
        {'si': 'බෝල ස්පර්ශ', 'ta': 'பந்து தொடு', 'en': 'Touch ball'}
      ]
    },
    {
      ...
      'actions': [
        {'si': 'කුඩ අරින්න', 'ta': 'குடை பிடி', 'en': 'Hold cup'},
        {'si': 'කුඩ පිරින්න', 'ta': 'குடை நிரப்பு', 'en': 'Fill cup'},
        {'si': 'කුඩ හීස්තින්න', 'ta': 'குடை குடிக្க', 'en': 'Drink from cup'}
      ]
    },
    {
      'si': 'පැන්සල්',
    ...
    },
    {
      ...
      'emoji': '💡',
      'actions': [
        {'si': 'දිලි දල්', 'ta': 'விளக்கு இயக્क', 'en': 'Turn on light'},
        {'si': 'දිලි බඳ', 'ta': 'விளக்கु அணை', 'en': 'Turn off light'},
        {'si': 'දිලි ස්පර්ශ', 'ta': 'விளக్కு தொடु', 'en': 'Touch light'}
      ]
    },
    {
      'si': 'සිටුවම්',
      ...
      'emoji': '🪑',
      'actions': [
        {'si': 'සිටුවම් ගිණිසි', 'ta': 'நாற्काலி உட్કार', 'en': 'Sit on chair'},
        {'si': 'සිටුවම් ස්පර්ශ', 'ta': 'நாற్काலி தொடु', 'en': 'Touch chair'},
        {'si': 'සිටුවම් නැතිවීම', 'ta': 'நாற్काலி எழு', 'en': 'Stand up'}
      ]
    },
    {
      'si': 'මේස',
      ...
      'emoji': '🛏️',
      'actions': [
        {'si': 'මේස උඩින් දැමුණු', 'ta': 'மేజ్ మీద वैय', 'en': 'Put on table'},
        {'si': 'මේස ස්පර්ශ', 'ta': 'మేజ్ తొడు', 'en': 'Touch table'},
        {'si': 'මේස ගිණිසි', 'ta': 'మేజ్ మీద కూర', 'en': 'Eat at table'}
      ]
    },
    {
      'si': 'ඇඳුම්',
      ...
      'actions': [
        ...
        {'si': 'ඇඳුම් පිහිනුම', 'ta': 'உடை ఆరు', 'en': 'Dry clothes'},
        {'si': 'ඇඳුම් ස්පර්ශ', 'ta': 'உடை தொடு', 'en': 'Touch clothes'}
      ]
    },
  ],
  'colors': [
    {
      ...
      'emoji': '🔴',
      'actions': [
        {'si': 'රතු දෙකිතින්න', 'ta': 'சிவப్பు కాషय', 'en': 'Show red'},
        {'si': 'රතු සොයන්න', 'ta': 'సిವप్పు तेडు', 'en': 'Find red'},
        {'si': 'රතු ස్පර්ශ', 'ta': 'సిവప్పු తొడు', 'en': 'Touch red'}
      ]
    },
    {
      'si': 'නිල්',
      ...
      'emoji': '🔵',
      'actions': [
        {'si': 'නිල් දෙකිතින්න', 'ta': 'నీలం కాషయ', 'en': 'Show blue'},
        {'si': 'නිල් සොයන්න', 'ta': 'నీలం तेడు', 'en': 'Find blue'},
        {'si': 'නිල් ස්පර්ශ', 'ta': 'నీలం తొడు', 'en': 'Touch blue'}
      ]
    },
    {
      'si': 'කහ',
      ...
      'emoji': '🟡',
      'actions': [
        {'si': 'කහ දෙකිතින්න', 'ta': 'మంజన కాషయ', 'en': 'Show yellow'},
        {'si': 'කහ සොයන්න', 'ta': 'మంజన तेडु', 'en': 'Find yellow'},
        {'si': 'කහ ස්පර්ශ', 'ta': 'మంజన తొడు', 'en': 'Touch yellow'}
      ]
    },
    {
      'si': 'ගිරවෙ',
      ...
      'emoji': '🟢',
      'actions': [
        {'si': 'ගිරවෙ දෙකිතින්න', 'ta': 'పచ్చై कāषய', 'en': 'Show green'},
        {'si': 'ගිරවෙ සොයන්න', 'ta': 'పచ్చై तेडु', 'en': 'Find green'},
        {'si': 'ගිරවෙ ස්පර්ශ', 'ta': 'పచ્చை తొడు', 'en': 'Touch green'}
      ]
    },
    {
      'si': 'තද කැලඹ',
      ...
      'emoji': '⚫',
      'actions': [
        {'si': 'තද දෙකිතින්න', 'ta': 'నలుపు కாషయ', 'en': 'Show black'},
        {'si': 'තද සොයන්න', 'ta': 'నలుపు तेডु', 'en': 'Find black'},
        {'si': 'තද ස්පර්ශ', 'ta': 'నలుపు తొడు', 'en': 'Touch black'}
      ]
    },
  ],
  'numbers': [
    {
      ...
      'emoji': '1️⃣',
      'actions': [
        {'si': 'එක ගණන් කරන්න', 'ta': 'ఒన్ना ఎంణ్న', 'en': 'Count one'},
        {'si': 'එක දෙකිතින්න', 'ta': 'ఒన్ना కాషయ', 'en': 'Show one'},
        {'si': 'එක ස්පර්ශ', 'ta': 'ఒన్ना తొడు', 'en': 'Touch one'}
      ]
    },
    {
      'si': 'දෙක',
      ...
      'emoji': '2️⃣',
      'actions': [
        {'si': 'දෙක ගණන් කරන්න', 'ta': 'ఇరండు ెంణ్న', 'en': 'Count two'},
        {'si': 'දෙක දෙකිතින්න', 'ta': 'ఇరండు కाषয', 'en': 'Show two'},
        {'si': 'දෙක ස්පර්ශ', 'ta': 'ఇరండు తొడు', 'en': 'Touch two'}
      ]
    },
    {
      'si': 'තුන',
      ...
      'emoji': '3️⃣',
      'actions': [
        {'si': 'තුන ගණන් කරන්න', 'ta': 'మూన్ను ెంణ్న', 'en': 'Count three'},
        {'si': 'තුන දෙකිතින්න', 'ta': 'మూన్ను కાషய', 'en': 'Show three'},
        {'si': 'තුන ස්පර්ශ', 'ta': 'మూన్ను తొడు', 'en': 'Touch three'}
      ]
    },
    {
      'si': 'හතර',
      ...
      'emoji': '4️⃣',
      'actions': [
        {'si': 'හතර ගණන් කරන්න', 'ta': 'నాన్కు ెంణ్న', 'en': 'Count four'},
        {'si': 'හතර දෙකිතින්න', 'ta': 'నాన్కు కाষय', 'en': 'Show four'},
        {'si': 'හතර ස්පර්ශ', 'ta': 'నాన్కు తొడు', 'en': 'Touch four'}
      ]
    },
    {
      'si': 'පස',
      ...
      'emoji': '5️⃣',
      'actions': [
        {'si': 'පස ගණන් කරන්න', 'ta': 'ఐంధు ెంణ్న', 'en': 'Count five'},
        {'si': 'පස දෙකිතින්න', 'ta': 'ఐంధు కाषय', 'en': 'Show five'},
        {'si': 'පස ස්පර්ශ', 'ta': 'ఐంధు తొడు', 'en': 'Touch five'}
      ]
    },
    {
      'si': 'හයි',
      ...
      'emoji': '6️⃣',
      'actions': [
        {'si': 'හයි ගණන් කරන්න', 'ta': 'ஆறு ెంణ్న', 'en': 'Count six'},
        {'si': 'හයි දෙකිතින්න', 'ta': 'ஆறு కాషయ', 'en': 'Show six'},
        {'si': 'හයි ස්පර්ශ', 'ta': 'ஆறු తొడු', 'en': 'Touch six'}
      ]
    },
    {
      'si': 'හත',
      ...
      'emoji': '7️⃣',
      'actions': [
        {'si': 'හත ගණන් කරන්න', 'ta': 'ஏழு ెంణ్న', 'en': 'Count seven'},
        {'si': 'හත දෙකිතින්න', 'ta': 'ஏழु කాషయ', 'en': 'Show seven'},
        {'si': 'හත ස්පර්ශ', 'ta': 'ஏழు తొడු', 'en': 'Touch seven'}
      ]
    },
    {
      'si': 'අට',
      ...
      'emoji': '8️⃣',
      'actions': [
        {'si': 'අට ගණන් කරන්න', 'ta': 'எட்டு ెంణ్న', 'en': 'Count eight'},
        {'si': 'අට දෙකිතින්න', 'ta': 'எட్టు కాషయ', 'en': 'Show eight'},
        {'si': 'අට ස්පර්ශ', 'ta': 'எட්టు తొడు', 'en': 'Touch eight'}
      ]
    },
    {
      'si': 'නවය',
      ...
      'emoji': '9️⃣',
      'actions': [
        {'si': 'නවය ගණන් කරන්න', 'ta': 'ஒன்பது ెంణ్న', 'en': 'Count nine'},
        {'si': 'නවය දෙකිතින්න', 'ta': 'ஒன్పது కాషయ', 'en': 'Show nine'},
        {'si': 'නවය ස්පර්ශ', 'ta': 'ஒன్పது తొడు', 'en': 'Touch nine'}
      ]
    },
    {
      'si': 'දහය',
      ...
      'emoji': '🔟',
      'actions': [
        {'si': 'දහය ගණන් කරන්න', 'ta': 'பத்து ెంణ్న', 'en': 'Count ten'},
        {'si': 'දහය දෙකිතින්න', 'ta': 'பத்து కாషయ', 'en': 'Show ten'},
        {'si': 'දහය ස්පර්ශ', 'ta': 'பத్து තొడු', 'en': 'Touch ten'}
      ]
    },
  ],
  'needs': [
    {
      ...
      'emoji': '🍴',
      'actions': [
        {'si': 'කෑම අවශ්‍යයි', 'ta': 'உணவு వేణ్డం', 'en': 'I want food'},
        {'si': 'බත් කනවා', 'ta': 'సోరు సापిటు', 'en': 'Eat rice'},
        {'si': 'සුවඳ කනවා', 'ta': 'సువండ్ కనవా', 'en': 'Tasty food'}
      ]
    },
    {
      'si': 'බොන්න ඕනා',
      ...
      'emoji': '🥤',
      'actions': [
        {'si': 'වතුර අවශ්‍යයි', 'ta': 'తણ్నీరు వేణ్డం', 'en': 'I want water'},
        {'si': 'කිරි හීස්තින්න', 'ta': 'పాలు కుడిక్క', 'en': 'Drink milk'},
        {'si': 'ශීතල බීම', 'ta': 'కుళిర్ పానం', 'en': 'Cold drink'}
      ]
    },
    {
      'si': 'නාන්න ඕනා',
      ...
      'emoji': '🚿',
      'actions': [
        {'si': 'නාන්න අවශ්‍යයි', 'ta': 'కుళిక్క వేణ්డం', 'en': 'I need bath'},
        {'si': 'උණුසුම් වතුර', 'ta': 'సూటान తణ్నీరు', 'en': 'Warm water'},
        {'si': 'සබු භාවිතයි', 'ta': 'సబు ఉపయోగం', 'en': 'Use soap'}
      ]
    },
    {
      'si': 'නිදාගන්න',
      ...
      'emoji': '😴',
      'actions': [
        {'si': 'නිදුණු යෑම', 'ta': 'తూంకు పో', 'en': 'Go sleep'},
        {'si': 'නිදුණු ඔසවා දිනුම්', 'ta': 'తూంకు ఎల్లె', 'en': 'Wake up'},
        {'si': 'නිදුණු ගවේසන', 'ta': 'తూంకు పేసు', 'en': 'Sleep talk'}
      ]
    },
    {
      'si': 'උදව් ඕනා',
      ...
      'emoji': '🆘',
      'actions': [
        {'si': 'උදව් කරන්න ඉවසා', 'ta': 'ఉదవీ సోల్లా', 'en': 'Please help'},
        {'si': 'කුමක් සිදුවුණේ', 'ta': 'ఎన్ना నటందతో', 'en': 'What happened'},
        {
          'si': 'ඔබ අවශ්‍ය දෙයි',
          'ta': 'మీరు ఏమి చేదు',
          'en': 'What do you need'
  ...
  'sentences': [
    {
      ...
      'actions': [
        {
          'si': 'ස්තුතියි ගොඩ ලැබීම',
          'ta': 'నన్రీ పెద్దగా',
          'en': 'Thank you very much'
        },
        {'si': 'ස්තුතියි උදව්', 'ta': 'ఉదవీకు నన్రీ', 'en': 'Thanks for help'},
        {
          'si': 'ස්තුතියි කිසිවෙක්',
          'ta': 'నిన్ను నన్రీ',
    ...
    },
    {
      ...
      'emoji': '👋',
      'actions': [
        {'si': 'කරුණාකර සිටින්න', 'ta': 'దయ చేసి నిల్లిన', 'en': 'Please wait'},
        {'si': 'කරුණාකර එකතු', 'ta': 'దయ చేసి చేరు', 'en': 'Please join'},
        {'si': 'කරුණාකර ඉවසා', 'ta': 'దయ చేసి ఎక్కువ', 'en': 'Please more'}
      ]
    },
    {
      'si': 'ඔව්',
      ...
      'emoji': '✅',
      'actions': [
        {'si': 'ඔව් නිශ්චිත', 'ta': 'ఆమ్ నిచ్చయం', 'en': 'Yes sure'},
        {'si': 'ඔව් සහමතයි', 'ta': 'ఆమ్ సమ్మతం', 'en': 'Yes agree'},
        {'si': 'ඔව් නිශ్චිතයි', 'ta': 'ఆమ్ సరిగా', 'en': 'Yes correct'}
      ]
    },
    {
      'si': 'නැහැ',
      ...
      'emoji': '❌',
      'actions': [
        {'si': 'නැහැ නිසි', 'ta': 'ఐలై థాంక్స్', 'en': 'No thanks'},
        {'si': 'නැහැ අවශ්‍යයි නොවේ', 'ta': 'ఐలై చేయలేని', 'en': 'No cannot'},
        {'si': 'නැහැ බුද්ධිමතිය', 'ta': 'ఐలై అర్థం', 'en': 'No understand'}
      ]
    },
    {
      'si': 'ඩිපීටි ගිණිසි',
      ...
      'emoji': '😔',
      'actions': [
        {'si': 'ඩිපීටි ගිණිසි', 'ta': 'మన్న చేసికవుమ్', 'en': 'I am sorry'},
        {'si': 'ඩිපීටි කරිණ', 'ta': 'మన్న చేసే కారణం', 'en': 'Sorry reason'},
        {'si': 'ඩිපීටි අවුරුදු', 'ta': 'మన్న సిద్ధం', 'en': 'Sorry ready'}
      ]
    },
  ],
};
